...
class WebWorkbenchTest(unittest.TestCase):
    ...
    def test_detect_workflow_marks_mixed_signals_for_regular_initial_interview_summary_negation(self):
        details = web_workbench.detect_workflow_details(
    ...
    def test_detect_workflow_marks_mixed_signals_for_standard_initial_interview_summary_risk_block_negation(self):
        details = web_workbench.detect_workflow_details(
    ...
    def test_detect_workflow_marks_mixed_signals_for_bilingual_standard_risk_block_negation(self):
        details = web_workbench.detect_workflow_details(
    ...
    def test_handle_demo_catalog_uses_english_validation_prompts(self):
        ...
        self.assertIn("regular-intake-summary-negation-to-bps-background", scenario_ids)
        self.assertIn("bilingual-risk-block-negation-to-bps-background", scenario_ids)
