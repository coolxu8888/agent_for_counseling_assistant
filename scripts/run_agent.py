...
def detect_w1_mode(user_input):
    ...
    summary_patterns = [
        ...
        r"fixed template.*(?:summarize|organize|structure)",
        r"\u9996\u8bbf",
        r"\u9996\u6b21\u8bbf\u8c08",
        r"\u7b2c\u4e00\u6b21\u8bbf\u8c08",
        r"\u521d\u8bbf\u603b\u7ed3",
...
def _validate_w6(workflow, data):
    ...
    if _contains_forbidden_scope(
        ...
        allowed_negated_phrases=[
            ...
            "not a diagnosis, fixed treatment prescription, final risk judgment, or guaranteed outcome",
            "not a diagnosis, fixed treatment prescription, final risk judgment, or guaranteed outcome.",
            "do not promise a fixed treatment protocol or guaranteed outcome",
            "do not promise a fixed treatment protocol or guaranteed outcome.",
