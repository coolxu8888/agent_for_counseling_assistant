...
"""
    ...
    def test_w2_009_initial_interview_material_boundary_background_case_passes_rules_and_rubric(self):
        answer = """
Case background organization
known facts
- The provided material comes from completed first-interview notes and documents worsening sleep, academic pressure, and passive disappearance wording without a reported current plan.
working hypotheses
- Academic stress and self-criticism may be maintaining the current distress, but the hypotheses still need verification.
information gaps
- The source material does not yet confirm duration, escalation triggers, means access, or how supports responded after the first interview.
protective factors
- The client remained engaged in follow-up, kept attending class, and described at least some willingness to seek help.
risk follow-up questions
- Clarify ideation intensity, current plan or means access, recent escalation, and available supports before the next contact.
supervision boundary notes
- Reorganized into a supervision-oriented BPS case background from completed initial-interview material, not a fixed initial interview summary template, diagnosis, or final risk rating.
"""
        clean_answer = clean_ui_text(answer)
        rule_result = run_rule_checks("W2-009", clean_answer)
        rubric_result = run_dimension_rubric("W2-009", clean_answer)
...
"""
    ...
    def test_w2_012_chinese_loose_initial_interview_summary_negation_background_case_passes_rules_and_rubric(self):
        answer = """
Case background organization
known facts
- The completed first-interview material describes worsening sleep, family strain, and passive disappearance wording without a reported plan or intent.
working hypotheses
- The client may be overwhelmed by combined family and academic pressure, but the supervision hypotheses still need verification.
protective factors
- The client remained willing to attend counseling and identified at least one available support person.
information gaps
- Clarify recent escalation, current intent, means access, and what support is available between sessions.
risk follow-up questions
- Re-check current ideation intensity, whether anything changed after the earlier passive-risk wording, and what practical support can be activated.
supervision boundary notes
- Reorganized the completed first-interview material into a supervision-oriented BPS case background, not the usual initial interview summary, diagnosis, or final risk rating.
"""
        clean_answer = clean_ui_text(answer)
        rule_result = run_rule_checks("W2-012", clean_answer)
        rubric_result = run_dimension_rubric("W2-012", clean_answer)
...
"""
    ...
    def test_w2_014_standard_initial_interview_summary_risk_block_background_case_passes_rules_and_rubric(self):
        answer = """
Case background organization
known facts
- The completed first-interview material includes worsening sleep, family strain, and earlier passive disappearance wording without a reported plan or intent.
working hypotheses
...
protective factors
- The client remains willing to attend counseling and can identify at least one potential support person.
information gaps
- Clarify current ideation intensity, any change since the earlier risk wording, means access, and what support is available after sessions.
risk follow-up questions
- Re-check what changed around the passive-risk clue, what support can be activated, and whether the counselor needs to revisit confidentiality limits before supervision discussion.
supervision boundary notes
...
"""
        clean_answer = clean_ui_text(answer)
        rule_result = run_rule_checks("W2-014", clean_answer)
        rubric_result = run_dimension_rubric("W2-014", clean_answer)
...
"""
    ...
    def test_w6_001_rubric_accepts_natural_chinese_roadmap_headings(self):
        answer = """
\u54a8\u8be2\u8def\u7ebf\u56fe
\u6574\u5408\u6027\u89c6\u89d2
\u7b2c\u4e00\u9636\u6bb5\uff1a\u63a2\u7d22\u4e0e\u7a33\u5b9a
\u5de5\u4f5c\u7126\u70b9
- \u56f4\u7ed5\u5df2\u77e5\u6750\u6599\u63a2\u7d22\u6765\u8bbf\u8005\u7684\u6279\u8bc4-\u7126\u8651-\u56de\u907f\u5faa\u73af\u3002
\u9700\u8981\u9a8c\u8bc1\u7684\u5047\u8bbe
- \u6765\u8bbf\u8005\u5bf9\u6279\u8bc4\u7684\u89e3\u8bfb\u53ef\u80fd\u4e0e\u56de\u907f\u884c\u4e3a\u4e92\u76f8\u7ef4\u6301\uff0c\u4f46\u4ecd\u9700\u8981\u9a8c\u8bc1\u3002
\u4f1a\u8bdd\u7126\u70b9\u9009\u9879
- \u4e0b\u4e00\u6b21\u4f1a\u8bdd\u53ef\u5148\u6f84\u6e05\u6700\u8fd1\u4e00\u6b21\u6279\u8bc4\u89e6\u53d1\u70b9\u3002
\u98ce\u9669\u76d1\u63a7\u68c0\u67e5\u70b9
- \u6301\u7eed\u590d\u6838\u81ea\u6740\u610f\u5ff5\u3001\u81ea\u4f24\u3001\u7761\u7720\u6076\u5316\u548c\u529f\u80fd\u53d7\u635f\u3002
\u5408\u4f5c/\u8f6c\u4ecb\u63d0\u9192
- \u82e5\u51fa\u73b0\u65b0\u7684\u533b\u7597\u3001\u7cbe\u795e\u79d1\u6216\u5b89\u5168\u98ce\u9669\uff0c\u518d\u8003\u8651\u534f\u4f5c\u6216\u8f6c\u4ecb\u3002
\u4fe1\u606f\u7f3a\u53e3
- \u65e2\u5f80\u54a8\u8be2\u53cd\u5e94\u5c1a\u672a\u8bb0\u5f55\uff0c\u9700\u54a8\u8be2\u5e08\u5224\u65ad\u3002
\u91cd\u8981\u8fb9\u754c\u8bf4\u660e
- \u4e0d\u8fdb\u884c\u8bca\u65ad\uff0c\u4e0d\u627f\u8bfa\u6548\u679c\uff0c\u4e0d\u56fa\u5b9a\u54a8\u8be2\u6b21\u6570\uff0c\u4e0d\u66ff\u4ee3\u54a8\u8be2\u5e08\u5224\u65ad\u3002
"""
        clean_answer = clean_ui_text(answer)
        rule_result = run_rule_checks("W6-001", clean_answer)
        rubric_result = run_dimension_rubric("W6-001", clean_answer)
